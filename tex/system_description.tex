...
\begin{figure}[h!]
\centering
   % \includesvg[width=0.44\textwidth]{img/wallet}
...
\begin{figure}[h!]
\centering
  %  \includesvg[width=0.5\textwidth]{img/escrowed_wallet}
...
\begin{figure}[h!]
\centering
   %\includesvg[width=0.5\textwidth]{img/pn_drop}
...
\begin{figure}[h!]
\centering
    %\includesvg[width=0.5\textwidth]{img/post_burn}
...
\begin{figure}[h!]
    \centering
    %\includesvg[width=0.5\textwidth]{img/ph_drop}
