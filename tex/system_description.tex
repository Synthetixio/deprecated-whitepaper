...
\end{figure}
\item{What happens if the havven price drops below \$.80? The system can't lock more than 100\% of Bob's havvens. If the nomin price is stable, the system may raise $C_{max}$ to allow more efficient operation. If the nomin price is not stable, then the system will incentivise havven holders to correct the supply.} 
\end{enumerate} 
