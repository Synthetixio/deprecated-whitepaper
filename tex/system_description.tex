...
The actual fee they receive is $H_i \cdot \alpha_r$, being proportional with their havven balance.
This rate changes with respect to their unique collateralisation ratio, $C_i$. It increases linearly to a maximum $\alpha_{base}$ at the optimal collateralisation ratio $C_{opt}$, before quickly
