...
\todo{Address how to maintain baseline demand.}
\todo{Address the role of the Havven foundation.}
\todo{Outline basic verbs for market players.}

\todo{Move analytical subsections from functional description section to the qualitative analysis and/or rationale sections.}
