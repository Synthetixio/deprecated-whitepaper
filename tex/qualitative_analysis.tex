...
\todo{List expected players in the market.}
\todo{Outline incentives and actions for different players.}
\todo{Address possible attacks against the system.}
