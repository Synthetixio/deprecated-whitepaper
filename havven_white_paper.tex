...
transactions, and dispersed proportionally among collateral holders.
Growth in transaction volume thus increases the value of the collateral,
allowing the stable token supply to expand to meet demand.
The resulting system retains the best features of Bitcoin, while the introduction
